...
var _user$project$Entities$Note = F2(
	function (a, b) {
...
var _user$project$Routes$QuickNote = {ctor: 'QuickNote'};
...
var _user$project$Routes$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routes$QuickNote,
				_evancz$url_parser$UrlParser$s('quick-note')),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Routes$decode = function (location) {
	return A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Routes$routeParser, location);
};
var _user$project$Routes$NotFound = {ctor: 'NotFound'};

var _user$project$Pages_Home_Model$initialHomeModel = {welcome: ''};
var _user$project$Pages_Home_Model$HomeModel = function (a) {
	return {welcome: a};
};

var _user$project$Pages_QuickNote_Model$initialQuickNoteModel = {
	noteBody: '',
	noteTitle: '',
	notes: {ctor: '[]'}
};
var _user$project$Pages_QuickNote_Model$QuickNoteModel = F3(
	function (a, b, c) {
		return {noteBody: a, noteTitle: b, notes: c};
	});
...
var _user$project$Types$NoPage = {ctor: 'NoPage'};
var _user$project$Types$QuickNotePage = function (a) {
	return {ctor: 'QuickNotePage', _0: a};
};
var _user$project$Types$HomePage = function (a) {
	return {ctor: 'HomePage', _0: a};
};

var _user$project$Model$initialModel = {route: _user$project$Routes$NotFound, page: _user$project$Types$NoPage};
var _user$project$Model$Model = F2(
	function (a, b) {
		return {route: a, page: b};
	});

var _user$project$Pages_QuickNote_Msg$AddNote = {ctor: 'AddNote'};
var _user$project$Pages_QuickNote_Msg$UpdateNoteBody = function (a) {
	return {ctor: 'UpdateNoteBody', _0: a};
};
var _user$project$Pages_QuickNote_Msg$UpdateNoteTitle = function (a) {
	return {ctor: 'UpdateNoteTitle', _0: a};
};

var _user$project$Msg$QuickNoteMsg = function (a) {
	return {ctor: 'QuickNoteMsg', _0: a};
};
var _user$project$Msg$Navigate = function (a) {
...
var _user$project$Pages_QuickNote_Update$quickNoteUpdate = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						notes: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Entities$Note, model.noteTitle, model.noteBody),
								_1: {ctor: '[]'}
							})
					});
		}
	...
	function (msg, model) {
		...
		do {
			if (_p0.ctor === '_Tuple2') {
				switch (_p0._0.ctor) {
					case 'UrlChange':
						return A2(_user$project$UpdateRoutes$urlChange, _p0._0._0, model);
					case 'Navigate':
						return A2(_user$project$UpdateRoutes$routeChange, _p0._0._0, model);
					default:
						if ((_p0._1.ctor === 'Loaded') && (_p0._1._0.ctor === 'QuickNotePage')) {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{
										page: _user$project$Types$Loaded(
											_user$project$Types$QuickNotePage(
												A2(_user$project$Pages_QuickNote_Update$quickNoteUpdate, _p0._0._0, _p0._1._0._0)))
									}),
								{ctor: '[]'});
						} else {
							break _v0_3;
...
var _user$project$Pages_QuickNote_View$renderNote = function (note) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('list-group-item flex-column align-items-start'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(note.body),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Pages_QuickNote_View$quickNoteView = function (model) {
	var disableSave = _elm_lang$core$String$isEmpty(model.noteTitle) || _elm_lang$core$String$isEmpty(model.noteBody);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('QuickNote'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(model.noteTitle),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(
																			function (_p0) {
																				return _user$project$Msg$QuickNoteMsg(
																					_user$project$Pages_QuickNote_Msg$UpdateNoteTitle(_p0));
																			}),
																		_1: {ctor: '[]'}
																	}
																}
										...
										_1: {
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$textarea,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(model.noteBody),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(
																			function (_p1) {
																				return _user$project$Msg$QuickNoteMsg(
																					_user$project$Pages_QuickNote_Msg$UpdateNoteBody(_p1));
																			}),
																		_1: {ctor: '[]'}
																	}
																}
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('btn btn-success float-right'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Msg$QuickNoteMsg(_user$project$Pages_QuickNote_Msg$AddNote)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$disabled(disableSave),
																_1: {ctor: '[]'}
															}
														}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Save Note'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										A2(_elm_lang$core$List$map, _user$project$Pages_QuickNote_View$renderNote, model.notes)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$View$renderPage = function (page) {
	var _p0 = page;
	if (_p0.ctor === 'HomePage') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('This is the home page...You shouldn\'t be here...'),
				_1: {ctor: '[]'}
			});
	} else {
		return _user$project$Pages_QuickNote_View$quickNoteView(_p0._0);
	}
};
var _user$project$View$renderPageState = function (model) {
	var _p1 = model.page;
	switch (_p1.ctor) {
		case 'NoPage':
			return A2(
		...
		case 'Loaded':
			return _user$project$View$renderPage(_p1._0);
		default:
			return A2(
				_elm_lang$html$Html$p,
				{ctor: '[]'},
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Noteworthy'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$renderPageState(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$init = function (location) {
	return A2(
		...
		_user$project$Msg$UrlChange(location),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Msg.Msg":{"args":[],"tags":{"QuickNoteMsg":["Pages.QuickNote.Msg.QuickNoteMsg"],"Navigate":["Routes.Route"],"UrlChange":["Navigation.Location"]}},"Routes.Route":{"args":[],"tags":{"Home":[],"NotFound":[],"QuickNote":[]}},"Pages.QuickNote.Msg.QuickNoteMsg":{"args":[],"tags":{"AddNote":[],"UpdateNoteBody":["String"],"UpdateNoteTitle":["String"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Msg.Msg"},"versions":{"elm":"0.18.0"}});
}
